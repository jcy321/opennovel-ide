...
process.on('unhandledRejection', (reason, p) => {
	// Ignore web-tree-sitter errors (not critical for build)
	if (reason && reason.message && reason.message.includes('tree_sitter')) {
		console.log('Ignoring web-tree-sitter warning:', reason.message);
		return;
	}
